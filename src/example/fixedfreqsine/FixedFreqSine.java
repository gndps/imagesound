...
public class FixedFreqSine {
  ...
  // public static void main(String[] args)
		 public FixedFreqSine(double frequency,int time)throws InterruptedException, LineUnavailableException {
      final int SAMPLING_RATE = 44100;              // Audio sampling rate
      final int SAMPLE_SIZE = 2;                    // Audio sample size in bytes

      SourceDataLine line;
      double fFreq = frequency;                           // Frequency of the sine wave
      ...
      int ctSamplesTotal = SAMPLING_RATE*time;         // Output for roughly 'time' seconds
